    ...
    <div className="flex flex-col min-h-screen bg-muted/20">
      ...
      <main className="flex-grow container mx-auto p-4 md:p-8 flex items-center justify-center">
        <Card className="max-w-md w-full text-center shadow-lg">
          <CardHeader>
            <CardTitle className="text-2xl pt-4">Book a Homestay</CardTitle>
            <CardDescription>Plan your stay in {cityName}.</CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-muted-foreground">
              This feature is coming soon! You are seeing this page because you are successfully logged in.
            </p>
            <Button className="mt-6">Explore Homestays</Button>
          </CardContent>
        </Card>
      </main>
    </div>
